    ...
    <main class="container">
        <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
            <div class="col-lg-6 px-0">
                <h1 class="display-4 fst-italic">Bienvenu dans la boutique Kane et Frère</h1>
                <p class="lead my-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus et vulputate neque. Aliquam sollicitudin rhoncus mi at fermentum. Morbi non.</p>
